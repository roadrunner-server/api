...
var file_http_v1beta_http_proto_rawDesc = []byte{
	...
	,
...
var file_http_v1beta_http_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_http_v1beta_http_proto_goTypes = []interface{}{
	...
	(*Body)(nil),            // 8: http.v1beta.Body
	nil,                     // 9: http.v1beta.Header.HeaderEntry
	nil,                     // 10: http.v1beta.Response.HeadersEntry
	nil,                     // 11: http.v1beta.Uploads.UploadsEntry
	nil,                     // 12: http.v1beta.FileHeader.HeaderEntry
}
var file_http_v1beta_http_proto_depIdxs = []int32{
	...
	9,  // 4: http.v1beta.Header.header:type_name -> http.v1beta.Header.HeaderEntry
	10, // 5: http.v1beta.Response.headers:type_name -> http.v1beta.Response.HeadersEntry
	11, // 6: http.v1beta.Uploads.uploads:type_name -> http.v1beta.Uploads.UploadsEntry
	...
	12, // 9: http.v1beta.FileHeader.header:type_name -> http.v1beta.FileHeader.HeaderEntry
	1,  // 10: http.v1beta.Body.header:type_name -> http.v1beta.Header
	7,  // 11: http.v1beta.Header.HeaderEntry.value:type_name -> http.v1beta.HeaderValue
	7,  // 12: http.v1beta.Response.HeadersEntry.value:type_name -> http.v1beta.HeaderValue
	4,  // 13: http.v1beta.Uploads.UploadsEntry.value:type_name -> http.v1beta.FileUploadArray
	7,  // 14: http.v1beta.FileHeader.HeaderEntry.value:type_name -> http.v1beta.HeaderValue
